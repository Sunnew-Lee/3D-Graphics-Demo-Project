...
struct Object
{
    int meshID;
    glm::vec4 color;
    glm::mat4 selfMat;       /*  self transformation that don't affect children, if any */
    glm::mat4 tMat;          /*  relative translation from parent, if any */
    glm::vec3 rotAxis;       /*  rotation about the parent, if any */
    float rotAmount;
    int imageID;        /*  ID for texture */

    Object(int meshID, glm::vec4 color,
        glm::mat4 selfMat, glm::mat4 tMat = glm::mat4(1.0f), glm::vec3 rotAxis = YAXIS, float rotAmount = 0.0f,
        int imageID = -1) :
...
{
    TORUS,
    glm::vec4(0.2f, 0.1f, 0.1f, 1.0f),                               /*  Color */
    Translate(0.0f, -9.4f, 0.0f)
    * Scale(20.5f, 16.0f, 20.5f),                             /*  Self-transform */
    glm::mat4(1.0f),                                                 /*  Translation w.r.t. parent */
...
const Object part[NUM_PARTS]
{
    {   /*  TORSO       */
        CUBE,
        glm::vec4(0.5f, 0.5f, 1.0f, 1.0f),                           /*  Color */
    ...
    },
    {
        /*  HEAD        */
        SPHERE,
        glm::vec4(1.0f, 0.83f, 0.16f, 1.0f),                         /*  Color */
    ...
    {   /*  HAT         */
        CONE,
        glm::vec4(0.55f, 0.85f, 0.95f, 1.0f),                        /*  Color */
    ...
    {   /*  LEFT ARM    */
        CYLINDER,
        glm::vec4(0.6f, 0.6f, 1.0f, 1.0f),                           /*  Color */
    ...
    {   /*  RIGHT ARM   */
        CYLINDER,
        glm::vec4(0.7f, 0.7f, 1.0f, 1.0f),                           /*  Color */
        Translate(0.0f, -2.0f, 0.0f) * Scale(0.7f, 4.0f, 0.7f), /*  Self-transform: translate off so that center of rotation is at shoulder */
        Translate(-1.6f, 1.8f, 0.0f),                           /*  Translation w.r.t. parent */
        XAXIS,                                                  /*  Rotation w.r.t. parent */
        -EIGHTH_PI
    ...
    {   /*  LEFT LEG    */
        CYLINDER,
        glm::vec4(0.19f, 0.22f, 0.26f, 1.0f),                        /*  Color */
    ...
    {   /*  LEFT FOOT    */
        CUBE,
        glm::vec4(0.2f, 0.2f, 0.4f, 1.0f),                           /*  Color */
