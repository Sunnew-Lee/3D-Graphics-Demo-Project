...
void Render()
{
    ...
    glTexStorage2D(GL_TEXTURE_2D, 1, GL_DEPTH_COMPONENT24, 
        static_cast<GLsizei>(width * resolutionPercen), static_cast<GLsizei>(height * resolutionPercen));
    ...
    glViewport(0, 0, static_cast<GLsizei>(width * resolutionPercen), static_cast<GLsizei>(height * resolutionPercen));
